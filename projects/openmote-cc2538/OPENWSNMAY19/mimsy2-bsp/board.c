...
void board_init(void) {
   ...
   clock_init();
   board_timer_init();
 //  leds_init(); //changed for urocket code
  // debugpins_init(); //changed for urocket code
   //button_init();
   sctimer_init();
  // uart_init(); //changed for urocket code
   radio_init();
   i2c_init(); //changed for urocket code
  // sensors_init(); changed for urocket
  // cryptoengine_init(); changed for urocket
}
